...
public class TweetsRetweetsAmountQueryHandlerTest {
	...
	TweetsRetweetsAmountQueryHandler qh = new TweetsRetweetsAmountQueryHandler();
	...
	@Test
	public void test() {
		assertEquals(new Integer(2), qh.getRetweetsAmount(ROOT_ID));
	}
